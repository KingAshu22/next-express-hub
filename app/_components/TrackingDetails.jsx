...
export default function TrackingDetails({ parcelDetails }) {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 space-y-6">
      {/* Header Card (From → To) */}
      <Card className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-white shadow-lg overflow-hidden">
        <CardContent className="p-6">
          <div className="flex items-center justify-center gap-3 md:gap-6">
            <div className="text-center">
              <p className="text-sm text-yellow-100 mb-1">From</p>
            ...
            <div className="text-center">
              <p className="text-sm text-yellow-100 mb-1">To</p>
      ...
      <Card className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-lg">
        <CardHeader className="flex flex-col md:flex-row items-center justify-between">
          <CardTitle className="text-2xl font-bold flex items-center gap-3">
            Tracking Details
            <span className="flex items-center bg-white text-indigo-700 rounded-lg px-3 py-1 text-sm font-semibold shadow-sm">
      ...
      <Card className="shadow-sm border border-gray-100">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-indigo-700">Shipment Details</CardTitle>
        </CardHeader>
